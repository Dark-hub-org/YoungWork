...
class Vacancies(models.Model):
    ...
    salary_min = models.BigIntegerField(blank=True, null=True, max_length=100, default='')
    salary_max = models.BigIntegerField(blank=True, null=True, max_length=100, default='')
