...
<!--                <div class="upload-image__cross"></div>-->
          ...
          <form class="parameters-form">
            ...
            <div class="parameters-form__wrapper">
              ...
              <input v-model="nameVacancy" type="text" class="parameters-form__wrapper__text" placeholder="ООО “Маршмеллоу”">
            </div>
            <div class="parameters-form__wrapper">
              <span class="parameters-form__wrapper__name">Уровень заработной платы:</span>
              <input v-model="levelSal" type="text" class="parameters-form__wrapper__text price margin-bottom" placeholder="От">
              <input v-model="levelSalMar" type="text" class="parameters-form__wrapper__text price margin-bottom" placeholder="До">
              <div class="radio-wrapper">
                <input v-model="salaryTax" type="radio" name="salary" value="beforeTax" class="parameters-filter__input" id="beforeDed" checked>
                <label for="beforeDed" class="parameters-filter-label radio">До вычета налогов</label>
              </div>
              <div class="radio-wrapper">
                <input v-model="salaryTax" type="radio" name="salary" value="afterTax" class="parameters-filter__input" id="afterDed">
            ...
            <div class="parameters-form__wrapper">
              ...
              <div class="radio-wrapper">
                <input v-model="employ" type="radio" name="employ" value="fullEmploy" class="parameters-filter__input" id="fullEmploy" checked>
                <label for="fullEmploy" class="parameters-filter-label radio">Полная занятость</label>
              </div>
              <div class="radio-wrapper">
                <input v-model="employ" type="radio" name="employ" value="partialEmploy" class="parameters-filter__input" id="partialEmploy">
                <label for="partialEmploy" class="parameters-filter-label radio">Частичная занятость</label>
              </div>
              <div class="radio-wrapper">
                <input v-model="employ" type="radio" name="employ" value="internship" class="parameters-filter__input" id="internship">
                <label for="internship" class="parameters-filter-label radio">Стажировка</label>
              </div>
              <div class="radio-wrapper">
                <input v-model="employ" type="radio" name="employ" value="projectWork" class="parameters-filter__input" id="projectWork">
                <label for="projectWork" class="parameters-filter-label radio">Проектная работа</label>
              </div>
              <div class="radio-wrapper">
                <input v-model="employ" type="radio" name="employ" value="volunteering" class="parameters-filter__input" id="volunteering">
            ...
            <div class="parameters-form__wrapper">
                ...
                <div class="radio-wrapper">
                  <input v-model="experience" type="radio" name="exp" value="0" class="parameters-filter__input" id="exp-1" checked>
                ...
                <div class="radio-wrapper">
                  <input v-model="experience" type="radio" name="exp" value="noExp" class="parameters-filter__input" id="exp-4">
